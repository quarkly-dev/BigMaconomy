export default {
	...
	"font": {
		"headline1": "normal 300 72px/1.2 --fontFamily-sans",
		"headline2": "normal 500 42px/1.2 --fontFamily-sans",
		"headline3": "normal 400 22px/1.5 --fontFamily-sans",
		"base": "normal 300 16px/1.2 --fontFamily-sans",
		"lead": "normal 300 20px/1.5 --fontFamily-sans",
		"headline4": "normal 300 72px/1.2 --fontFamily-sans"
	},
	"boxShadow": {
